...
A técnica mais precisa para determinar o \textit{redshift} de um objeto é a espectroscopia, pois permite a identificação de características espectrais específicas, como linhas de absorção e emissão, possibilitando medidas confiáveis do deslocamento para o vermelho. Logo, tradicionalmente, os \textit{redshifts} espectroscópicos são considerados valores de referência devido à alta precisão do método [REF]. No entanto, esse procedimento depende de tempos de observação longos, instrumentação sofisticada e é limitado pela sensibilidade de telescópios [REF], tornando inviável sua aplicação em larga escala.
